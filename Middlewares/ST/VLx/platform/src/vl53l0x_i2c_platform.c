...
int32_t VL53L0X_write_multi(uint8_t address, uint8_t reg, uint8_t *pdata, int32_t count)
{
    ...
    status = HAL_I2C_Mem_Write(&hi2c1, address, (uint16_t)reg, I2C_MEMADD_SIZE_8BIT, pdata, count, 0xFF);
...
int32_t VL53L0X_read_multi(uint8_t address, uint8_t index, uint8_t *pdata, int32_t count)
{
    ...
    status = HAL_I2C_Mem_Read(&hi2c1, address, (uint16_t)index, I2C_MEMADD_SIZE_8BIT, pdata, count, 0xFF);
